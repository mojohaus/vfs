    ...
    extends AbstractVfsTestCase
{
        ...
        throws Exception
    {
        ...
        Assert.assertEquals( expectedMetadata.getVersioning().getVersions(),
                             resultMetadata.getVersioning().getVersions() );
        ...
        throws Exception
    {
        ...
        Metadata expectedMetadata =
            readMetadata( new File( basedir, "src/test/data/metadata/maven-metadata-1-2-3.xml" ) );
        Metadata resultMetadata = readMetadata( finalFile );
        Assert.assertEquals( expectedMetadata.getVersioning().getVersions(),
                             resultMetadata.getVersioning().getVersions() );
        ...
        // order matter
        Assert.assertFalse( expectedMetadata.getVersioning().getVersions().equals( resultMetadata.getVersioning().getVersions() ) );
